    ...
    return (
        <div className="component-button-panel">
          <div>
            ...
            <Button name="^" clickHandle={handleClick} gray/>
            <Button name="ln" clickHandle={handleClick} gray/>
            <Button name="Pi" clickHandle={handleClick} gray/>
          </div>
          <div>
            <Button name="sen" clickHandle={handleClick} gray/>
            <Button name="cos" clickHandle={handleClick} gray/>
            <Button name="tan" clickHandle={handleClick} gray/>
            <Button name="exp" clickHandle={handleClick} gray/>
          </div>
          <div>
